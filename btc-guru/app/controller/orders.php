...
class OrdersController extends Controller {
    ...
    public function show() {
        ...
        $this->notFoundIf($order->state == \Sovrin\OrderModel::$STATES['unconfirmed'] && $this->user->is_vendor);
    ...
    public function confirm() {
        ...
        $this->accessDeniedUnless($order->state == \Sovrin\OrderModel::$STATES['unconfirmed']);
    ...
    public function accept() {
        ...
        $this->accessDeniedUnless($order->state == \Sovrin\OrderModel::$STATES['confirmed']);
    ...
    public function shipped() {
        ...
        $this->accessDeniedUnless($this->user->is_vendor);
        # only paid orders
        $this->accessDeniedUnless($order->state == \Sovrin\OrderModel::$STATES['paid']);
    ...
    public function destroy() {
        ...
        $orderModel = $this->getModel('Order');
        $order = $orderModel->getOneOfUser($this->user->id, $this->user->is_vendor, $this->post['h'], $_SESSION['k']);
        $this->notFoundUnless($order && \Sovrin\OrderModel::isDeletable($order, $this->user->id));
    ...
    public function dispute() {
        ...
        # check order states
        $this->accessDeniedUnless(in_array($order->state, [\Sovrin\OrderModel::$STATES['paid'], \Sovrin\OrderModel::$STATES['shipped'], \Sovrin\OrderModel::$STATES['dispute']]));
