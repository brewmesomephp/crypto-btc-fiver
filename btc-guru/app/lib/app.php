 ...
 * Class App
 * @package Sovrin
 * @author Joseph Alai <joseph.alai@gmail.com>
 *
...
class App {
    ...
    private function dispatchToController($db) {
        ...
        if($this->isValidControllerAndAction($controllerName, $actionName)) {
            # convert controller from param (c=bla) to CamelCase Sovrin\BlaController
            $controllerClassName = "Sovrin\\" . mb_convert_case($controllerName, MB_CASE_TITLE, "UTF-8") . "Controller";
