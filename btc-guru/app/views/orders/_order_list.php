<table class="full-width">
    ...
    <?php foreach($orders as $order): ?>
        <tr>
            ...
            <td>
                <span class="label <?= \Sovrin\OrderModel::needsActionFrom($this->user->is_vendor, $order->state) ? 'alert' : 'secondary' ?>">
                    <?= $this->e(\Sovrin\OrderModel::stateDescription($order->state)) ?>
                </span>
            </td>
            <td>
            ...
            <td>
                <?php if(\Sovrin\OrderModel::isDeletable($order, $this->user->id)): ?>
